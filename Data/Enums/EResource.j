scope EResource
  /*
  struct EMainType
    static constant integer Character = 1
    static constant integer Skill     = 2
    static constant integer Stat      = 3
    static constant integer Option    = 4
  endstruct
  */
  ...
  struct EStatType
    // 용어 설명
      ...
      // 증폭 (Multiplier): 확률과 같으나, 총 값을 한번 더 증폭시킴.
