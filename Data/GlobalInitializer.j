scope GlobalInitializer
  ...
  struct CharacterData
    ...
    static method Create takes integer index, unit base, integer unitCode, string strings returns nothing
      set privateCharacterData[index] = thistype.allocate()
