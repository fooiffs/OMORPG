scope Info initializer Init
  ...
  private function CreateInfo takes nothing returns nothing
   local integer i = 1
    ...
    call SkillTree.MakeLineY(Frame_Info[0], .055, -.01, .265)
    call SkillTree.MakeLineX(Frame_Info[0], .045, -.0275, .02)
    call SkillTree.MakeLineX(Frame_Info[0], .035, -.0525, .04)
    call SkillTree.MakeLineX(Frame_Info[0], .045, -.0770, .02)
    call SkillTree.MakeLineX(Frame_Info[0], .035, -.1025, .04)
    call SkillTree.MakeLineX(Frame_Info[0], .045, -.1380, .02)
    call SkillTree.MakeLineX(Frame_Info[0], .035, -.1750, .04)
    call SkillTree.MakeLineX(Frame_Info[0], .035, -.2125, .04)
    call SkillTree.MakeLineX(Frame_Info[0], .025, -.2400, .06)
